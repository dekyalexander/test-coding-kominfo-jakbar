<nav class="navbar default-layout col-lg-12 col-12 p-0 fixed-top d-flex align-items-top flex-row">
      <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-start">
        ...
        <div>
          <a class="navbar-brand brand-logo" href="{{url('superadmin')}}">
          <label> <img src="{{asset('admin/images/logo-jakbar.jpg')}}" width="30" height="30" alt="logo" /> KOMINFO</label>
          </a>
          <a class="navbar-brand brand-logo-mini" href="{{url('superadmin')}}">
          <img src="{{asset('admin/images/logo-jakbar.jpg')}}" width="30" height="30" alt="logo" />
          </a>
        </div>
      </div>
