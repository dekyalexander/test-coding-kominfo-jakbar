...
<div class="main-panel">
                          ...
                          <div class="col-12 grid-margin stretch-card">
                            <div class="card card-rounded">
                              <div class="card-body">
                                ...
                                <a class="btn btn-success btn-sm" href="javascript:void(0)" id="createDocument"> Create Document</a> <a class="btn btn-warning btn-sm float-end" href="{{ route('document.export') }}">Export Document</a>
        ...
        var table = $('.data-document').DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{ route('document-ajax-crud.index') }}",
            columns: [
        ...
        $.get("{{ route('document-ajax-crud.index') }}" +'/' + doc_id +'/edit', function (data) {
            ...
            $('#saveBtn').click(function (e) {
              ...
              $.ajax({
                ...
                url: "{{ route('document-ajax-crud.store') }}",
                type: "POST",
                dataType: 'json',
            ...
            $.ajax({
                type: "DELETE",
                url: "{{ route('document-ajax-crud.store') }}"+'/'+doc_id,
                success: function (data) {
                    table.draw();
                },
                error: function (data) {
